...
public class BAIParser extends Parser {
	...
	public BAIParser(TokenStream input) {
		super(input);
		_interp = new ParserATNSimulator(this,_ATN,_decisionToDFA,_sharedContextCache);
	}

	public static class BaiContext extends ParserRuleContext {
		public TerminalNode BAI() { return getToken(BAIParser.BAI, 0); }
	...
	public final BaiContext bai() throws RecognitionException {
		...
		enterRule(_localctx, 0, RULE_bai);
		try {

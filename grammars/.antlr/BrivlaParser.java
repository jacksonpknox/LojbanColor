...
public class BrivlaParser extends Parser {
	...
	public static final int
		RULE_brivla = 0, RULE_lujvo = 1, RULE_gismu = 2;
	...
	public BrivlaParser(TokenStream input) {
		super(input);
	...
	public final BrivlaContext brivla() throws RecognitionException {
		...
		enterRule(_localctx, 0, RULE_brivla);
		try {
			setState(8);
	...
	public static class LujvoContext extends ParserRuleContext {
		public TerminalNode LUJVO() { return getToken(BrivlaParser.LUJVO, 0); }
	...
	public final LujvoContext lujvo() throws RecognitionException {
		...
		enterRule(_localctx, 2, RULE_lujvo);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(10);
	...
	public static class GismuContext extends ParserRuleContext {
		public TerminalNode GISMU() { return getToken(BrivlaParser.GISMU, 0); }
	...
	public final GismuContext gismu() throws RecognitionException {
		...
		enterRule(_localctx, 4, RULE_gismu);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(12);
	...
	public static final String _serializedATN =
		...
		"\t\3\4\4\t\4\3\2\3\2\5\2\13\n\2\3\3\3\3\3\4\3\4\3\4\2\2\5\2\4\6\2\2\2"+
		"\16\2\n\3\2\2\2\4\f\3\2\2\2\6\16\3\2\2\2\b\13\5\4\3\2\t\13\5\6\4\2\n\b"+
		"\3\2\2\2\n\t\3\2\2\2\13\3\3\2\2\2\f\r\7\5\2\2\r\5\3\2\2\2\16\17\7\4\2"+
		"\2\17\7\3\2\2\2\3\n";
